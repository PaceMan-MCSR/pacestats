    ...
    return <div className="recentRunsFull">
        ...
        <table className="table table-dark table-bordered table-sm">
            ...
            <tr className="paceHeader">
                <th>Time</th>
                <th>
                    <img src="/stats/nether.webp" alt="Nether" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">Nether</p>
                </th>
                <th>
                    <img src="/stats/bastion.webp" alt="Bastion" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">Bastion</p>
                </th>
                <th>
                    <img src="/stats/fortress.webp" alt="Fortress" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">Fortress</p>
                </th>
                <th>
                    <img src="/stats/first_portal.webp" alt="First Portal" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">First Portal</p>
                </th>
                <th>
                    <img src="/stats/stronghold.webp" alt="Stronghold" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">Stronghold</p>
                </th>
                <th>
                    <img src="/stats/end.webp" alt="End" className="icon d-block d-md-none"/>
                    <p className="d-none d-md-inline">End</p>
                </th>
                <th>
                    <img src="/stats/finish.webp" alt="Finish" className="icon d-block d-md-none"/>
