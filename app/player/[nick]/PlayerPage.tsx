...
import { defaultNameColor, getDisplayName, getNameColor } from "@/app/utils";

export default async function PlayerPage({name, uuid, recentRuns, twitches, nph, data, days, bf, users}: {
    name: string,
    uuid: string,
    recentRuns: {},
    twitches: any[],
    ...
    return (
        <UsersContext.Provider value={users}>
            <main className="main playerStats">
                <div className="container">
                    <ResetScroll/>
                    <h1 className="header" style={{marginTop: 20, marginBottom: 30}}>
                        Stats for <span style={{color: nameColor}}>{getDisplayName(users, uuid, name)}</span>
                    ...
                    <div className="row">
                        <div className="d-none d-lg-block col-sm-3 col-md-2 col-lg-2 col-xl-2">
                            <img className="playerSkin" src={skinUrl} style={nameColor !== defaultNameColor ? {
                                filter: `drop-shadow(0px 0px 5px ${nameColor}) drop-shadow(0px 0px 20px #000000)`
                            } : {}} alt="Player skin"/>
                        </div>
                        ...
                        <div className="d-none d-sm-block d-md-block d-lg-none col-sm-6 col-md-6 mt-md-5">
                            <img className={twitches !== null && twitches.length > 1 ? "playerSkin-tall" : "playerSkin"}
